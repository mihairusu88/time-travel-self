...
import { signupSchema, type SignupFormData } from '@/constants/validationSchema'
...
export default function SignupPage() {
  ...
  if (loading) {
    return (
      <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-gray-100 dark:bg-background font-display text-gray-800 dark:text-gray-200">
  ...
  return (
    <div className="relative flex min-h-[calc(100vh-85px-80px)] w-full flex-col overflow-hidden bg-gray-100 dark:bg-background font-display text-gray-800 dark:text-gray-200">
      <div className="relative flex h-full grow flex-col">
        <main className="flex flex-1 items-center justify-center p-4">
          <div className="w-full max-w-md space-y-8 rounded-xl bg-card backdrop-blur-sm p-8 border border-gray-200 dark:border-gray-700">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tighter text-gray-900 dark:text-white">
                Create your account
              </h2>
              <p className="mt-2 text-gray-600 dark:text-gray-400">
                Transform your photos into cinematic images.
              </p>
            </div>
